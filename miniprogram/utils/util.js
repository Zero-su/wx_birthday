var lunarInfo=new Array(
  ...
  function calElement(sYear,sMonth,sDay,week,lYear,lMonth,lDay,isLeap,cYear,cMonth,cDay) {
    ...
    // this.color      = '';
    this.astro = getAstro(sMonth, sDay)
...
const timeDiff = function(strBgnDate, strEndDate) {
  ...
  //把相差的毫秒数转换为天数
  nYlts = parseInt((oEndDate - oBgnDate) / 1000 / 60 / 60 / 24);
  return nYlts
}

const day2ymrStr2 = function (sdate, edate) {
  var day2ymrStr = "";
